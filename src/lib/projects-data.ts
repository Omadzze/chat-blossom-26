...
export const SLICE = {
  title: "Простой производственных мощностей: 169 предприятий",
  subtitle: "Срез: июнь 2026 · по текущим фильтрам",
  ...
  tiles: [
    { label: "Выпуск с начала года", value: "19,2", of: "из 979,9 млрд сум", percent: 2, note: "2% прошлогоднего выпуска" },
    { label: "Рабочие места", value: "2 527", of: "из 4 102", percent: 62, note: "62% мест по прошлой отчётности" },
    { label: "Без причины", value: "36", of: "из 169", percent: 21, note: "21% группы, причина не указана" },
  ],
  conclusion:
